...
<div class=" bd-productoverview vm-product-item"  >
 ...
 col-md-8">
    <div class="bd-layoutcolumn-64 bd-column" ><div class="bd-vertical-align-wrapper"><h2 class=" bd-productoverviewtitle-1 bd-no-margins">
...
<?php endif ?></div></div>
 ...
 col-md-4">
    <div class="bd-layoutcolumn-65 bd-column" ><div class="bd-vertical-align-wrapper"><?php if (isset($productItems->productPrice)) : ?>
...
<div class=" bd-pricetext-14">
    ...
    <span class=" bd-container-36 bd-tagstyles bd-custom-blockquotes bd-custom-button bd-custom-image bd-custom-table bd-no-margins salesPrice">
...
<form method="post" class="product" action="<?php echo JRoute::_ ('index.php'); ?>">
    <?php
        ...
        $buttonDataAttrs = '';
        $classNames = ' bd-productbuy-4 bd-no-margins bd-button';
    ?>
