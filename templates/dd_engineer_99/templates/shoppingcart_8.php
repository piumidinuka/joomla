...
<body class=" bootstrap bd-body-8  bd-pagebackground-296 bd-margins">
...
?>
		...
		<section class=" bd-section-14 bd-tagstyles" id="section7" data-section-title="Section">
    <div class="bd-container-inner bd-margins clearfix">
        <?php 
    renderTemplateFromIncludes('breadcrumbs_20');
?>
    </div>
</section>
