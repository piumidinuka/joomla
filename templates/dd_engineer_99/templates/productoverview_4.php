...
<body class=" bootstrap bd-body-4  bd-pagebackground-123 bd-margins">
...
?>
		...
		<section class=" bd-section-13 bd-tagstyles" id="section7" data-section-title="Section">
    <div class="bd-container-inner bd-margins clearfix">
        <?php 
    renderTemplateFromIncludes('breadcrumbs_19');
?>
    </div>
</section>
	
		<div class="bd-containereffect-5 container-effect container ">
<div class="bd-contentlayout-4  bd-sheetstyles-4  bd-no-margins bd-margins" >
    <div class="bd-container-inner">
