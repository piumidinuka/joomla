...
$megamenuClass = '';
$megamenuSubCatItemClass = 'bd-sub-item bd-mega-item  bd-menuitem-214';
...
ob_start();
?>
<div class="bd-menu-4  bd-mega-grid bd-grid-216">
...
ob_start();
?>
<div class="bd-menuitem-4 bd-sub-item bd-mega-item  bd-menuitem-212 separated-item-208">
    <div class="bd-griditem-208 bd-grid-item">
<?php
...
ob_start();
?>
<li class=" bd-menuitem-3 bd-toplevel-item {submenu_icon_only}">
<?php 
...
<?php $subMenuStartItem = ob_get_clean(); ?>
    ...
    if ($item->deeper) {
        ...
        ?>
        <div class="bd-menu-4-popup<?php echo $item->megaclass && $item->level == 2 ? ' bd-megamenu-popup' : ''; ?>">
